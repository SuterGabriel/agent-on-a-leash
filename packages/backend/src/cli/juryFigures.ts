...
writeFileSync(join(root, "docs", "pitch", "live-figures.md"), agg.join("\n"));
writeFileSync(join(root, "reports", "jury-figures.md"), full.join("\n"));
